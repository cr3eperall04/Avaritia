package com.cr3eperall.avaritiaalpha.render.shader;
...
public class ShaderHelper {
    ...
    private static final String PREFIX = "/assets/avaritiaalpha/shader/";
    ...
    public static void useShader(int shader, ShaderCallback callback) {
        ...
        if (shader != 0) {
            ...
            if (mc.player != null && mc.player.world != null) {
                ARBShaderObjects.glUniform1iARB(time, (int) (mc.player.world.getGameTime() % Integer.MAX_VALUE));
            }
