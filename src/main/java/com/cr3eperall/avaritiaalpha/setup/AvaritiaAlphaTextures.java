...
public class AvaritiaAlphaTextures {

    public static void registerIcons(TextureStitchEvent.Pre textureMap) {
        map = textureMap;
    ...
    private static TextureAtlasSprite register(String sprite) {
        TextureAtlasSprite sprit=null;
        ResourceLocation res=new ResourceLocation(sprite);
        //System.out.println(res.getPath());
        if (!map.addSprite(res)){
    ...
    private static TextureStitchEvent.Pre map;

    private static final String ITEMS_ = "avaritiaalpha:item/";
    private static final String MODELS_ = "avaritiaalpha:models/";
    private static final String SHADER_ = "avaritiaalpha:shader/";
    private static final String TOOLS_ = ITEMS_ + "tools_mask/";
